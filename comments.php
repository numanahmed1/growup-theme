...
<div id="comments" class="comments-area">
    ...
    <h2 class="comment-title">
         <?php 
            printf(
                esc_html( _nx( 'One comment on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'growuptheme' ) ),
    ...
    <?php growup_get_post_comments_nav(); ?>
    ...
    ?>
        <p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'growuptheme') ?></p>
    <?php  
        endif;
    ?>
    ...
    <?php 
        ...
        $args = array(
            ...
            'fields'        => apply_filters( 'comment_from_default_fields', $fields),
        );
