        ...
        <main id="main" class="site-main" roll="main">
            ...
            <div class="container text-center load-previous-container">
                <div class="load-btn-container">
                  <a class="growup-load-btn growup-load-more" data-prev="1" data-page="<?php echo growup_check_paged(1); ?>" 
                  data-archive="<?php echo growup_grab_current_uri(); ?>" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
            ...
            <div class="container text-center">
                  <div class="load-btn-container">
                    <a class="growup-load-btn growup-load-more" data-page="<?php echo growup_check_paged(1); ?>" 
                    data-archive="<?php echo growup_grab_current_uri(); ?>" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
                      <span class="growup-load-icon"><i class="fa fa-spinner" aria-hidden="true"></i></span>
